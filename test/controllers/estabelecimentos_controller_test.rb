...
class EstabelecimentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estabelecimento" do
    assert_difference("Estabelecimento.count") do
      post estabelecimentos_url, params: { estabelecimento: { cnpj: @estabelecimento.cnpj, endereco: @estabelecimento.endereco, nome: @estabelecimento.nome, telefone: @estabelecimento.telefone } }
    end
  ...
  test "should update estabelecimento" do
    patch estabelecimento_url(@estabelecimento), params: { estabelecimento: { cnpj: @estabelecimento.cnpj, endereco: @estabelecimento.endereco, nome: @estabelecimento.nome, telefone: @estabelecimento.telefone } }

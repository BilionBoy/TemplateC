...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference("Categoria.count") do
      post categorias_url, params: { categoria: { descricao: @categoria.descricao, estabelecimento_id: @categoria.estabelecimento_id, nome: @categoria.nome } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { descricao: @categoria.descricao, estabelecimento_id: @categoria.estabelecimento_id, nome: @categoria.nome } }
